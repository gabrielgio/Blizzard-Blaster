 ...
 */
public class BaseGun implements Entity {
    ...
    public BaseGun(World world) {
        ...
        bodyDef.position.set(bodyDef.position.x, (-((Gdx.graphics.getHeight() / GameSetting.PIXELS_TO_METERS) / 2) + .25f));
        ...
        //set in a random X but in a fixed Y(roof)
        bodyDefCir.position.set(bodyDefCir.position.x, (-((Gdx.graphics.getHeight() / GameSetting.PIXELS_TO_METERS) / 2) + 1.25f));
    ...
    public void update() {
        ...
        spriteCir.setPosition((bodyCir.getPosition().x * GameSetting.PIXELS_TO_METERS) - spriteCir.getWidth() / 2, (bodyCir.getPosition().y * GameSetting.PIXELS_TO_METERS) - spriteCir.getHeight() / 2);
